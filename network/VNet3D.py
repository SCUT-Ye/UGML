...
class VNet(nn.Module):
    def __init__(self, n_channels=1, n_classes=14, n_filters=32, normalization='gn', has_dropout=False):
        super(VNet, self).__init__()
        self.has_dropout = has_dropout

        self.block_one = ConvBlock(1, n_channels, n_filters, normalization=normalization)
        self.block_one_dw = DownsamplingConvBlock(n_filters, n_filters * 2, normalization=normalization) # 32

        self.block_two = ConvBlock(2, n_filters * 2, n_filters * 2, normalization=normalization)
        self.block_two_dw = DownsamplingConvBlock(n_filters * 2, n_filters * 4, normalization=normalization) # 64

        self.block_three = ConvBlock(3, n_filters * 4, n_filters * 4, normalization=normalization)
        self.block_three_dw = DownsamplingConvBlock(n_filters * 4, n_filters * 8, normalization=normalization) # 128

        # self.block_four = ConvBlock(3, n_filters * 8, n_filters * 8, normalization=normalization)
        # self.block_four_dw = DownsamplingConvBlock(n_filters * 8, n_filters * 16, normalization=normalization) # 256
        ...
        self.block_six = ConvBlock(3, n_filters * 2, n_filters * 2, normalization=normalization)
